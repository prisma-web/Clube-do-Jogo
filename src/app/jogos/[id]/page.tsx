  ...
  return (
    <div className="mx-auto max-w-4xl animate-fade-in">
      ...
      <section className="relative overflow-hidden rounded-[30px] border border-white/8 bg-white/[0.025] p-4 sm:p-7">
        <div className="absolute inset-x-0 top-0 h-60 opacity-15"><img src={game.image_url} alt="" className="size-full scale-125 object-cover blur-3xl" /><div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#101013]" /></div>
