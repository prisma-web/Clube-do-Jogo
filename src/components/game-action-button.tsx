...
const meta = {
  ...
  completed: { Icon: Flag, idle: 'Finalizar', active: 'Finalizado', activeClass: 'border-pink-400/30 bg-pink-500/[.12] text-pink-200', fillClass: 'fill-pink-400/25' },
  backlog: { Icon: Library, idle: 'Adicionar a Meus Jogos', active: 'Em Meus Jogos', activeClass: 'border-sky-400/25 bg-sky-500/[.10] text-sky-200', fillClass: 'fill-sky-400/20' },
} as const;
