      ...
      <div className="flex min-w-0 flex-1 flex-col justify-between py-0.5">
        <div className="min-w-0">
          ...
          <div className="mt-2 flex min-w-0 flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] text-zinc-500">
            ...
            {game.average_rating !== null && game.average_rating !== undefined && <span className="game-rating inline-flex items-center gap-1 whitespace-nowrap text-amber-400"><Star className="size-3 fill-current" />{(game.average_rating / 10).toLocaleString('pt-BR', { maximumFractionDigits: 1 })}</span>}
